...
const Navbar = () => {
    ...
    const navItems = <>
        ...
        <li className="mr-2" ><NavLink className="hover:bg-slate-300 p-3 rounded-xl " to="/about">About</NavLink> </li>
        <li className="mr-2" ><NavLink className="hover:bg-slate-300 p-3  rounded-xl " to="/contact">Contact</NavLink> </li>
