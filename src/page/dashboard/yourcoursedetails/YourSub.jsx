...
const YourSub = ({booking}) => {
    ...
    const {_id,course_id,course_name,course_image}=booking;
        ...
        <div>
            ...
            <div  className="card h-[350px] card-compact bg-base-100 shadow-xl hover:shadow-gray-500 hover:scale-95 hover:cursor-pointer transition ease-in-out delay-150">
                ...
                <div className="card-body">
                    <h2 className=" font-bold text-center  text-2xl">{course_name}</h2>
                    <hr></hr>
                    <h1 className="text-xl text-green-700" >Total Enrolled Person:  </h1>
